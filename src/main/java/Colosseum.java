...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        do {
            ...
            if (newHP > MAX_HIT_POINTS || newHP < 1) {
        ...
        do {
            ...
            newATK = build.nextInt();
            done = true;
            if (newATK > 49 || newATK < 1) {
                System.out.println("Sorry. Attack must be between 1 and 49:");
                done = false;
            }
        } while (!done);
        do {
            System.out.println("Enter your defense level (1-" + (49 - newATK) +  "):");
            newDEF = build.nextInt();
            done = true;
            if (newDEF > (49 - newDEF) || newDEF < 1) {
                System.out.println("Sorry. Defense must be between 1 and " + (49 - newATK) +  ":");
                done = false;
            }
        } while (!done);
    ...
    public static void printWhoIsAhead() {
        ...
        if (firstPokemon.hitPoints > secondPokemon.hitPoints) {
            ...
            System.out.println("It's head to head!");
        }
    }
